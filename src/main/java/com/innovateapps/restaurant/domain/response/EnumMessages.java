...
public enum EnumMessages {
    ...
    REGISTRO_ACTUALIZADO("El usuario fue actualizado","DAS-EP-0003",EnumTypeMessage.INFORMACION.getCodigo()),
    ...
    PARAMETROS_INCORRECTOS("Los datos registrados son incorrectos","INA-GG-0006",EnumTypeMessage.ERROR.getCodigo()),
